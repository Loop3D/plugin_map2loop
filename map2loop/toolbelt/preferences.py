...
# package
import map2loop.toolbelt.log_handler as log_hdlr
from map2loop.__about__ import __title__, __version__
from map2loop.toolbelt.env_var_parser import EnvVarParser

# ############################################################################
# ########## Classes ###############
# ##################################

PREFIX_ENV_VARIABLE = "QGIS_PLUGIN_MAP2LOOP_"
